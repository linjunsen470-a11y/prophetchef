  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        'Our integrated production line covers commercial induction cooking, gas cooking, dishwashing, ovens and custom kitchen equipment.',
      ],
    ...
    stats: [
      ['7000sqm', 'Factory', 'factory'],
      ['90+', 'Employees', 'users'],
      ['6', 'R&D Personnel', 'sparkles'],
      ['8', 'QC Inspectors', 'shieldCheck'],
      ['15', 'Sales Team', 'mailCheck'],
      ['8', 'After-sales Instructors', 'headset'],
